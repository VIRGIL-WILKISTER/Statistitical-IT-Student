...
7.	Computers use binary (0s and 1s) to represent all data.
Units: bit> byte> KB> MB> GB >TB.
Text uses ASCII/Unicode; images use pixels; audio uses sampled values.
4. Files
...
Regular Backups: Use external drives, optical media, or cloud storage (follow 3-2-1 backup rule)# Statistitical-IT-Student
